...
This migration:
- keeps customer and ship-to locations consistent
- keeps warehouse and physical locations consistent
- keeps picking stock consistent with allocation and stock location
- keeps allocated product consistent with stock product
- keeps shipment items connected to the shipment dispatch
- keeps delivery items connected to the delivery shipment
*/
